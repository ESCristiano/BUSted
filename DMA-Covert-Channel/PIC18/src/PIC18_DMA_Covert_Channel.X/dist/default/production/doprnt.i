...
# 1 "/opt/microchip/mplabx/v6.05/packs/Microchip/PIC18F-Q_DFP/1.14.237/xc8/pic/include/inline.h" 1 3
...
{
    int i, w;
# 164 "/opt/microchip/xc8/v2.41/pic/sources/c99/common/doprnt.c"
    w = (p < 0) ? 0 : p;
    i = 0;
    while (i < w) {
        fputc(' ', fp);
...
# 917 "/opt/microchip/xc8/v2.41/pic/sources/c99/common/doprnt.c"
...
# 1047 "/opt/microchip/xc8/v2.41/pic/sources/c99/common/doprnt.c"
static void
 ...
 union {
  ...
  long double f;
    ...
    if ((*fmt)[0] == '%') {
        ...
        flags = width = 0;
        prec = -1;
# 1143 "/opt/microchip/xc8/v2.41/pic/sources/c99/common/doprnt.c"
  cp = *fmt;
...
# 1256 "/opt/microchip/xc8/v2.41/pic/sources/c99/common/doprnt.c"
  ...
  if (0
# 1276 "/opt/microchip/xc8/v2.41/pic/sources/c99/common/doprnt.c"
    || *cp == 'u'
...
# 1342 "/opt/microchip/xc8/v2.41/pic/sources/c99/common/doprnt.c"
   }
  }
